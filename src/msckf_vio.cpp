...
void MsckfVio::predictNewState(const double& dt,
  ...
  // 采用了四元数的零阶积分，见论文《quaternion kinematics for error-state KF》第26页
...
void MsckfVio::featureJacobian(
  ...
  // 将当前能观测到当前特征点的相机对应的标号保存到valid_cam_state_ids
  ...
  // H_xj: 量测方程对系统状态的雅克比矩阵： 4M*(21+N*6)
  // H_fj: 量测方程对特征点的雅克比矩阵： 4M*3
  // H_xj: 量测残差： 4M*1
